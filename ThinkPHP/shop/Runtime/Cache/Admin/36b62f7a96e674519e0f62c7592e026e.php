                        ...
                        <tr height=20>
                            ...
                            <td>
                            	<!--
                                   	...
                                   	这个是 Index 显示的地址
                                   	href="/shop/index.php/Admin/index/index"
                                   	
                                   	相同点是/shop/index.pho/Admin , 所以用 __modelue__
                                --> 
                            	
                            	<a class=menuchild 
                                   href="/ThinkPHP/shop/index.php/Admin/Goods/showlist" 
                                   ...
                                   <!--
                                   	target:在什么页面显示超链接内容
                                   		...
                                   		__self:在本页面显示
                                   		__blank:在新标签页面显示
                                   		__top:去除所有的 frameset 框架内容 , 进而显示
                                   		frame的src值:在执行的frame页面显示
                                   		target="right" 是值向 right.html 这个页面显示

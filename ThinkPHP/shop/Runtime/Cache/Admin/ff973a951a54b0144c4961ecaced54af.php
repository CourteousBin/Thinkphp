        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/ThinkPHP/shop/index.php/Admin/Manager/login.html" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="/ThinkPHP/shop/index.php/Admin/Manager/verifyImg"  alt=""
                                                onclick="this.src='/ThinkPHP/shop/index.php/Admin/Manager/verifyImg/'+Math.random()" 
                                             />
                                        </li>
                                    </ul>
                                </div>
